...
const About = () => {
    return (
        <section id='about'>
            ...
            <div className='flex flex-col items-center  justify-center w-100 lg:w-full'>
            <h1 className='text-3xl underline mb-4 text-white font-semibold mt-4'>About</h1>
                ...
                <div className='flex flex-col items-center justify-center  p-4 w-80 lg:w-full'>
                    ...
                    <img className='rounded-lg h-130 w-100' src="/src/assets/im.jpg" alt="" />
                    <h2 className='text-xl text-white font-serif w-80 md:w-full sm:w-130 mt-4 text-justify md:text-3xl'>I am currently pursuing a Bachelor's degree in Computer Science and Engineering. My coursework includes programming, data structures, and web development. I am eager to apply my skills to real-world projects.</h2>
                </div>
                </div>
