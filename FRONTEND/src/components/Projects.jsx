  ...
  return (
    <div id="projects" className=" min-h-screen bg-black text-gray-300 flex flex-col items-center py-5">
      ...
      <div className="bg-gray-900 p-9  rounded-lg  w-150 md:w-200 lg:w-350 flex flex-col items-center justify-between ">
        ...
        <p className="text-xl  text-white font-serif w-90 sm:w-130 text-justify lg:w-full md:text-3xl"><strong>Frontend:</strong> <span className="text-blue-400">React.js, GSAP, JavaScript</span></p>
        <p className="text-xl  text-white font-serif w-90 sm:w-130 text-justify lg:w-full md:text-3xl"><strong>Backend:</strong> <span className="text-green-400">Express.js, Mongoose, MongoDB, Node.js</span></p>
        <div className="flex justify-center gap-4 mt-6 lg:gap-10 lg:h-100">
          <img className="h-40 lg:h-90 md:h-60 md:w-40 lg:w-70 w-26 rounded-lg shadow-lg " src="/src/assets/1.png" alt="Project Screenshot 1" />
          <img className="h-40 lg:h-90 md:h-60 md:w-40 lg:w-70 w-26 rounded-lg shadow-lg " src="/src/assets/2.png" alt="Project Screenshot 2" />
          <img className="h-40 lg:h-90 md:h-60 md:w-40 lg:w-70 w-26 rounded-lg shadow-lg " src="/src/assets/3.png" alt="Project Screenshot 3" />
        </div>
       ...
       Village Management System is a web-based application designed to digitally bridge the gap between village administration and villagers. It provides a centralized platform for administrators to post government schemes, public notices, and village updates, while villagers can stay informed and raise complaints with ease.
        ...
        <h3 className="text-2xl mt-3 text-white font-serif w-90 sm:w-130 text-justify lg:w-full md:text-3xl">Technology Used:</h3>
        <p className="text-xl  text-white font-serif w-90 sm:w-130 text-justify lg:w-full md:text-3xl"><strong>Frontend:</strong> <span className="text-blue-400">React.js, GSAP, JavaScript, Tailwind CSS</span></p>
        <p className="text-xl  text-white font-serif w-90 sm:w-130 text-justify lg:w-full md:text-3xl"><strong>Backend:</strong> <span className="text-green-400">Express.js, Mongoose, MongoDB, Node.js</span></p>
        <div className="flex justify-center gap-4 mt-6 lg:gap-10 lg:h-100">
          <img className="h-40 lg:h-90 md:h-60 md:w-40 lg:w-70 w-26 rounded-lg shadow-lg " src="/src/assets/smart1.png" alt="Project Screenshot 1" />
          <img className="h-40 lg:h-90 md:h-60 md:w-40 lg:w-70 w-26 rounded-lg shadow-lg " src="/src/assets/smart 2.png" alt="Project Screenshot 2" />
          <img className="h-40 lg:h-90 md:h-60 md:w-40 lg:w-70 w-26 rounded-lg shadow-lg " src="/src/assets/3.png" alt="Project Screenshot 3" />
        </div>
        <div className="mt-6 text-center">
          <span className="text-xl text-orange-400 font-semibold">Live: </span>
